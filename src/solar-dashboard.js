  ...
  _applyWeatherBackdrop(condition, windSpeed = 0, cloudCoverage = null, windBearing = 180, visibility = null) {
    ...
    if (this._weatherFx) {
      ...
      if (fxKey !== this._fxKey) {
        ...
        this._weatherFx.start(condition, isNight, theme, effWind, moonBrightness, moonElevation, moonAzimuth, sunElevation, sunAzimuth, effCloud, effBearing, effVis, effPI, effTS, effHI, effWC, effUV, effHum, effTemp);
        this._fxKey = fxKey;
      } else {
