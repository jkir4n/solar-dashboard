...
const L = {
  en: {
    ...
    descDischarging: 'Enable or disable battery discharging',
      ...
      ctrlAbsorption: 'Top Balancing', descAbsorption: 'No-load cell top balance',
  ...
  de: {
    ...
    batteryNode: 'Batterie', home: 'Haus', solarNode: 'Solar', grid: 'Netz',
  ...
  fr: {
    ...
    batteryNode: 'Batterie', home: 'Maison', solarNode: 'Solaire', grid: 'Réseau',
...
<div class="container">
  ...
  <div class="top-row">
    ...
    <div class="card" id="powerFlow">
            ...
            <div class="flow-hub">
              <div class="flow-hub-cell fh-solar-node">
                ...
                <div class="flow-hub-cell fh-solar-line">
    ...
    <div class="card" id="controlsCard">
      ...
      <div class="ctrl">
        <div><div class="ctrl-name">${t(lang, 'ctrlAbsorption')}</div><div class="ctrl-desc" id="absorptionDesc">${t(lang, 'absNotArmed')}</div><div class="ctrl-desc" id="absorptionDetails" style="font-size:0.78em;opacity:0.65;display:none"></div></div>
  ...
  _applyWeatherBackdrop(condition, windSpeed = 0, cloudCoverage = null, windBearing = 180, visibility = null) {
    ...
    if (this._weatherFx) {
      ...
      if (fxKey !== this._fxKey) {
        ...
        this._weatherFx.start(condition, isNight, theme, effWind, moonBrightness, moonElevation, moonAzimuth, sunElevation, sunAzimuth, effCloud, effBearing, effVis, effPI, effTS, effHI, effWC, effUV, effHum, effTemp, effPP);
        this._fxKey = fxKey;
      } else {
  ...
  async _fetchForecast() {
    ...
    try {
      ...
      const result = await this._bridge._hass.callWS({
        ...
        service_data: { entity_id: this._weatherEntityId, type: 'hourly' },
