...
const SENSOR_KEYWORDS = {
  SOC:          ['capacity_remaining', 'state_of_charge', 'battery_soc', 'soc', 'battery_percent'],
  VOLTAGE:      ['total_voltage', 'battery_voltage', 'pack_voltage'],
  CURRENT:      ['current', 'battery_current'],
  POWER:        ['power'],
  CHG_POWER:    ['charging_power', 'charge_power', 'battery_charge_power'],
  DISCHG_POWER: ['discharging_power', 'discharge_power', 'battery_discharge_power'],
  REMAINING:    ['capacity_remaining_derived', 'remaining_capacity', 'remaining_ah'],
  CYCLES:       ['charging_cycles', 'cycle_count', 'cycles'],
  ...
  FIRMWARE:     ['software_version', 'firmware_version'],
  TEMP1:        ['temperature_sensor_1', 'temperature_1', 'battery_temperature'],
  TEMP2:        ['temperature_sensor_2', 'temperature_2', 'temperature_mos'],
  MOSFET_TEMP:  ['power_tube_temperature', 'mosfet_temp', 'mos_temperature'],
  STRINGS:      ['battery_strings', 'cell_count', 'cell_number'],
  MANUFACTURER: ['manufacturer'],
  BATTERY_TYPE: ['battery_type', 'cell_chemistry', 'chemistry'],
};
...
const GRID_KEYWORDS = {
  ...
  GRID_STATUS:         ['grid_status', 'grid_connected', 'on_grid'],
