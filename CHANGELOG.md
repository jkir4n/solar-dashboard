...
### Features
- Enhance typography with tabular-nums and eliminate animation layout thrashing
...
### Bug Fixes
- Correct halo physics, rain NaN guard, cloud shadow origin, ISS snap
...
### Bug Fixes
- Render clouds for precipitation conditions by decoupling cloud render block from else-if chain
...
### Features
- Render nimbostratus/cumulonimbus clouds during precipitation conditions
...
### Bug Fixes
- Guard WeatherFX render loop against null canvas context; throttle forecast fetch retries on failure
- Solar-dashboard.js
- Solar-dashboard.js
- Weather-fx.js
...
### Bug Fixes
- Wire uvIndex/humidity/temperature through WeatherFX.start() to sunray renderer
- Solar-dashboard.js
- Solar-dashboard.js
- Weather-fx.js
- Weather-fx.js
...
### Bug Fixes
- Use WebSocket weather/forecast type for forecast data
...
### Bug Fixes
- Pass undefined for target in callService for get_forecasts
...
### Bug Fixes
- Fetch today's peak power from HA history instead of tracking from page load
...
### Bug Fixes
- Reorganize stats into 2 rows - money+peak and performance+panel
...
### Features
- Add smooth fade transitions to solar night mode
...
### Bug Fixes
- Weather hero card-in-card appearance and night empty state actual label
- Solar-dashboard.js
- Solar-dashboard.js
- Styles.js
...
### Bug Fixes
- Remove time from top-balancing last-run sub-line
- Solar-dashboard.js
...
### Bug Fixes
- Home flow line color reflects primary power source
- Fix power flow layout: move Home to right side of cross hub


## v0.40.1 (2026-05-08)

### Bug Fixes
- Power flow alignment - center Home node and stretch Grid line
...
### Bug Fixes
- Weather updates never get stuck — dynamic values always propagate
...
### Bug Fixes
- Restart weather FX on tab visibility restore
...
### Bug Fixes
- Smooth skeleton loading — no DOM swap, CSS overlay fades to real data
